...
{
	Edit1->Visible = true;
    Edit1->TextHint = "Название Района";
...
{
	ADOQuery11->Edit();
	ADOQuery11->FieldByName("Название_района")->AsString = Edit1->Text;
	ADOQuery11->Post();
	Edit1->Clear();
	Edit1->Visible = false;
	Button2->Visible = false;
...
{
 Edit1->Visible = true;
 Edit1->TextHint = "Наименование работы";
...
{
	ADOQuery2->Edit();
	ADOQuery2->FieldByName("Наименование_работы")->AsString = Edit1->Text;
	ADOQuery2->Post();
	Edit1->Clear();
	Edit1->Visible = false;
	Button4->Visible = false;
...
void __fastcall TForm8::Button3Click(TObject *Sender)
{
	...
	ADOQuery1->FieldByName("Возраст")->AsString = Edit2->Text;
	ADOQuery1->FieldByName("Возможные_работы")->AsString = ComboBox2->Text;
	ADOQuery1->Post();
	Edit1->Clear();
	Edit2->Clear();
	Edit1->Visible = false;
...
{
	Edit1->Visible = true;
	Edit1->TextHint = "Адерс";
	Edit2->Visible = true;
	Edit2->TextHint = "Кол-во жильцов";
	ComboBox3->Visible = true;
	Edit3->Visible = true;
	Edit3->TextHint = "Нужно $ для ремонта";
	ComboBox4->Visible = true;
	Edit4->Visible = true;
	Edit4->TextHint = "Доступно для ремонта";
...
void __fastcall TForm8::Button5Click(TObject *Sender)
{
	...
	ADOQuery3->FieldByName("Улица")->AsString = Edit1->Text;
	ADOQuery3->FieldByName("Количество_Жителей")->AsString = Edit2->Text;
	ADOQuery3->FieldByName("Стутус_дома")->AsString = ComboBox3->Text;
	ADOQuery3->FieldByName("Необходимый_бюджет_для_ремонта")->AsString = Edit3->Text;
	ADOQuery3->FieldByName("Район")->AsString = ComboBox4->Text;
	ADOQuery3->FieldByName("Доступный_бюджет")->AsString = Edit4->Text;
...
{
    ShowMessage("Щелчек правой кнопки мыши по выделенной ячейке вызывает меню настроек информации");
}
//---------------------------------------------------------------------------
